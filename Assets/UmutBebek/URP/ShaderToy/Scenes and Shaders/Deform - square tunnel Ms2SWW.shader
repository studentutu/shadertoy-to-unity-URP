Shader "UmutBebek/URP/ShaderToy/Deform - square tunnel Ms2SWW"
{
    Properties
    {
...
// Compare naive implementation of SAMPLE_TEXTURE2D fetching to gradient - discontinuity - aware 
...
// index SAMPLE_TEXTURE2D by ( animated inverse ) radious and angle 
float2 uv = float2 (0.3 / r + 0.2 * _Time.y , a / 3.1415927);

// naive fecth color 
float3 col = SAMPLE_TEXTURE2D(_Channel0 , sampler_Channel0 , uv).xyz;
