...
#define RED1 float3( 1.0 , 0.0 , 0.0 )
#define GREEN1 float3( 0.0 , 1.0 , 0.0 )
#define BLUE1 float3( 0.0 , 0.0 , 1.0 )
...
float3 col = float3 (smoothstep(0.2 , 1.0 , redIntensity + blueIntensity) , smoothstep(0.2 , 1.0 , redIntensity + blueIntensity) , smoothstep(0.2 , 1.0 , redIntensity + blueIntensity));

col += redIntensity * GREEN1;
 col += blueIntensity * BLUE1;
