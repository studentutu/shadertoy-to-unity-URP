Shader "UmutBebek/URP/ShaderToy/edge glow Mdf3zr"
{
    Properties
    {
...
float lookup(float2 p , float dx , float dy)
 {
    ...
    float4 c = SAMPLE_TEXTURE2D(_Channel0 , sampler_Channel0 , uv.xy);
...
float4 col = SAMPLE_TEXTURE2D(_Channel0 , sampler_Channel0 , p / _ScreenParams.xy);
